                    ...
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        <div class="modal-header model-heading">
                          <h5 class="modal-title modal-head" id="exampleModal11Label">
                            User Detail
                          </h5>
                        ...
                        <div class="role mb-2">
                             <h6 class="mb-1 fw-bold text-start">Departmane name</h6>
                            <div class="text-start">
                                <p class="m-0">{{ departdata.department_name }}</p>
                                </div>
                        </div>
                    </div>
...
export default {
    name: 'ModalComponent',
    props:JSON.parse(JSON.stringify(["departdata"])),
    mounted(){

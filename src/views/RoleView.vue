    ...
    <DashboardLayout>
      ...
      <div  class="dashbpoard-content px-0 px-md-5 py-4">
        ...
        <div class="total-department">
          <h5 class="mb-0">Total Roles = {{recordData}}</h5>
        </div>
        </div>
        <!-- *******team-content******* -->
        <div class="row">
                              ...
                              <form @submit.prevent="apply_filter_g">
                                <div class="mb-3 modal-input">
                                  ...
                                  <select class="form-select shadow-none" v-model="role_name_filter" aria-label="Default select example">
                                    ...
                                    <option v-for="data,index in role_obj" :key="index">{{data.role_name}}</option>
                          ...
                          <form @submit.prevent="add_role">
                            <div class="mb-3 modal-input">
                              ...
                              <input
                                ...
                                class="form-control"
                                id="recipient-name"
                                v-model="add_roless.role"
                                placeholder="Role name is required"
                              />
                               <span class="text-danger" v-if="v$.add_roless.role.$error">{{
                                v$.add_roless.role.$errors[0].$message
                              }}</span>
                            </div>
                             <div class="mb-3 modal-input">
                              <label for="recipient-name" class="col-form-label"
                              ...
                              <input
                                ...
                                class="form-control"
                                id="recipient-name"
                                v-model="add_roless.description"
                                 placeholder="Role description is required"
                              />
                               <span class="text-danger" v-if="v$.add_roless.description.$error">{{
                                v$.add_roless.description.$errors[0].$message
                              }}</span>
                            </div>
                    ...
                    <div class="table-responsive department-table">
                      <table class="table align-middle">
                        ...
                        <tbody> 
                          ...
                          <tr class="text-center department-action" v-for="(role,index) in role_datas" :key="index">
                                  ...
                                  >
                                    ...
                                    >
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body modal-form">
                                          <form @submit.prevent="update_role(update_r.id)">
                                            <div class="mb-3 modal-input">
                                              <label
                                                for="recipient-name"
                                              ...
                                              <input
                                                ...
                                                class="form-control"
                                                id="recipient-name"
                                                v-model="update_r.role"
                                              />
                                        <span class="text-danger" v-if="v$.update_r.role.$error">{{
                                          v$.update_r.role.$errors[0].$message
                                        }}</span>
                                            </div>
                                            <div class="mb-3 modal-input">
                                              <label
                                              ...
                                              <input
                                                ...
                                                class="form-control"
                                                id="recipient-name"
                                                 v-model="update_r.description"
                                              />
                                                <span class="text-danger" v-if="v$.update_r.description.$error">{{
                                                  v$.update_r.description.$errors[0].$message
                                                }}</span>
                                            </div>
                                              <div class="row bank-row justify-content-center">
                                    <div class="col-md-10 col-lg-4 col-xl-4">
                              ...
                              <button v-if="loadingupdate == false" type="submit" class="btn btn_save border w-100 py-2 shadow-none">
                                ...
                                <div class="edit-icon">
                                  <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    style="fill: var(--red)"
                                    @click="delete_role_data(role.id)"
                                  >
                                    <path
...
export default {
  ...
  mounted(){
    this.processChange = this.debounce(() => this.get_role());
  ...
  methods:{
    ...
    update_select(role){
           console.log(role);
           this.update_r.id = role.id;
           this.update_r.role = role.role_name;
           this.update_r.description = role.role_description;
    },
    //update data 
   async update_role(id){
      ...
      if (!result) {
        return;
             ...
             this.loadingupdate = true;
              let data={
                role_name:this.update_r.role,
                role_description:this.update_r.description,

              }
               console.log(data);
                let response = await ApiClass.updateNodeRequest("role-update?id="+id , true, data);
    ...
    reset_validaton(){
      ...
      this.add_roless.role = this.add_roless.description = "";
    },
      // get role 
      async get_role() {
        this.loading = true;
      ...
      if (response?.data) {
        ...
        if (response?.data?.status_code == "1") {
          console.log(response.data);
            ...
            this.role_obj = response?.data?.data ?? [];
    ...
    async add_role(){
       ...
       const result = await this.v$.add_roless.$validate();
      if (!result) {
        return;
      }
      ...
      let form_data = {
        ...
        role_name:this.add_roless.role,
        role_description:this.add_roless.description,
      };
       console.log(form_data)
      let response = await ApiClass.postNodeRequest("role-create", true, form_data);
      console.log(response.data);
      this.loading = false;
     ...
     delete_role_data(id) {
        // alert(id)
          ...
          async delete_role(id){
            // alert(id)
          let response = await ApiClass.deleteNodeRequest("role-delete?id="+id , true);
